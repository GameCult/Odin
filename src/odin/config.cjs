...
function buildConfig(argv) {
  ...
  const seedDeckUrls = String(args.eveDeckUrl || "ws://127.0.0.1:8795/eve/deck,ws://127.0.0.1:8796/eve/deck,ws://127.0.0.1:8799/eve/deck,ws://192.168.1.75:8795/eve/deck")
    .split(",")
